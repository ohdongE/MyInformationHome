  ...
  ko: {
    ...
    projects: {
      ...
      captions: {
        ...
        workoutHome: '이번 주 부족한 부위를 분석해 오늘의 추천 플랜을 보여줍니다.',
        workoutPlanSelect: '빈 플랜으로 즉석 시작하거나, 저장해둔 플랜 중 하나를 골라 운동을 시작합니다.',
        workoutFatigueMap: '근육별 회복 속도로 감쇠시킨 피로도를 인체 그림 위에 부위별로 표시합니다.',
        workoutVolumeRadar: '기간별 부위별 운동 볼륨을 레이더 차트로 비교해 균형을 확인합니다.',
        workoutSession: '세트마다 무게·횟수를 기록하며 실시간 타이머로 휴식 시간을 관리합니다.',
        workoutAiCoach: '운동별 핵심 자세와 흔한 실수, 템포·휴식 기준을 AI 코치가 알려줍니다.',
        workoutInbodyHistory: '인바디 CSV를 불러와 체중·골격근·체지방 변화를 날짜별로 기록합니다.',
        workoutInbodyCoach: '최근 측정값의 변화를 분석해 다음 방향을 제안하는 AI 코치 코멘트입니다.',
      },
    },
    contact: {
      label: 'Contact',
  ...
  en: {
    ...
    projects: {
      ...
      captions: {
        ...
        workoutHome: 'Analyzes which muscle groups were neglected this week and suggests today\'s plan.',
        workoutPlanSelect: 'Start on the fly with an empty plan, or pick one of your saved plans to begin.',
        workoutFatigueMap: 'Shows per-muscle fatigue, decayed by each muscle\'s recovery rate, on a body diagram.',
        workoutVolumeRadar: 'Compares training volume across muscle groups over a period on a radar chart.',
        workoutSession: 'Logs weight and reps for each set while a live timer manages rest periods.',
        workoutAiCoach: 'An AI coach walks through key form cues, common mistakes, and tempo/rest guidelines per exercise.',
        workoutInbodyHistory: 'Imports InBody CSV data and logs weight, skeletal muscle, and body fat changes by date.',
        workoutInbodyCoach: 'An AI coach comment that analyzes recent measurement changes and suggests the next direction.',
      },
    },
    contact: {
      label: 'Contact',
  ...
  ja: {
    ...
    projects: {
      ...
      captions: {
        ...
        workoutHome: '今週不足している部位を分析し、今日のおすすめプランを表示します。',
        workoutPlanSelect: '空のプランでその場で始めるか、保存済みのプランを選んで運動を開始します。',
        workoutFatigueMap: '筋肉ごとの回復速度で減衰させた疲労度を、人体図の部位ごとに表示します。',
        workoutVolumeRadar: '期間ごとの部位別トレーニングボリュームをレーダーチャートで比較します。',
        workoutSession: 'セットごとに重量・回数を記録し、リアルタイムタイマーで休憩時間を管理します。',
        workoutAiCoach: '種目ごとの正しいフォーム、よくあるミス、テンポ・休憩の目安をAIコーチが教えてくれます。',
        workoutInbodyHistory: 'InBodyのCSVを読み込み、体重・骨格筋・体脂肪の変化を日付ごとに記録します。',
        workoutInbodyCoach: '直近の測定値の変化を分析し、次の方向性を提案するAIコーチのコメントです。',
      },
    },
    contact: {
      label: 'Contact',
